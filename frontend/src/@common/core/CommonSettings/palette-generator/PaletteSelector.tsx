...
import { CommonThemeType } from '../CommonSettings';
...
type PaletteSelectorProps = {
	...
	value: CommonThemeType;
	onChange: (value: CommonThemeType) => void;
};
...
function PaletteSelector(props: PaletteSelectorProps) {
	...
	const methods = useForm<CommonThemeType>({
		defaultValues: {},
		mode: 'onChange'
	});
	...
	function onSubmit(formData: CommonThemeType) {
		onChange(formData);
		handleCloseDialog();
	}
