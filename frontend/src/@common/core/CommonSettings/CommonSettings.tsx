...
import ThemeFormConfigTypes from '@common/core/CommonSettings/ThemeFormConfigTypes';
...
/**
 * The Root styled component is used to style the root div of the CommonSettings component.
...
export type CommonThemesType = { [key: string]: CommonThemeType };

export type CommonSettingsConfigType = {
	layout: {
		style?: string;
	...
	direction: 'rtl' | 'ltr';
	theme: {
		main: CommonThemeType;
		navbar: CommonThemeType;
		toolbar: CommonThemeType;
...
/**
 * The CommonSettings component is responsible for rendering the settings form for the Common React application.
...
function CommonSettings() {
	...
	const handleUpdate = useDebounce((newSettings: CommonSettingsConfigType) => {
				...
				switch (formControl.type) {
						...
						return (
							<Controller
								...
								render={({ field }) => (
									<FormControl
										component="fieldset"
										className="CommonSettings-formControl"
									>
										<FormLabel
											component="legend"
											className="text-14"
					...
					case 'group': {
						return (
							<div
								key={target}
								className="CommonSettings-formGroup"
							>
								<Typography
									className="CommonSettings-formGroupTitle"
