 ...
 */
const CommonHighlight = forwardRef<HTMLDivElement, CommonHighlightProps>((props, ref) => {
...
function trimCode(children: CommonHighlightProps['children']) {
...
export default memo(styled(CommonHighlight)``);
