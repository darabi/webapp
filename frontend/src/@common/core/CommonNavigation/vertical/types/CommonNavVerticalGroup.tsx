...
/**
 * CommonNavVerticalGroup is a component used to render a group of navigation items in a vertical layout.
 */
function CommonNavVerticalGroup(props: CommonNavItemComponentProps) {
		...
		() => (
			<>
				<Root
					...
					className={clsx('common-list-subheader flex items-center  py-10', !item.url ? 'cursor-default' : '')}
