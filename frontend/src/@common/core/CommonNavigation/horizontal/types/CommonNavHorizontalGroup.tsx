...
type CommonNavHorizontalGroupProps = CommonNavItemComponentProps & WithRouterProps;

/**
 * CommonNavHorizontalGroup.
 * Represents a horizontal group component used in the Common navigation navigation list.
 * It shows the list item as well as its children with a flyout effect.
 */
function CommonNavHorizontalGroup(props: CommonNavHorizontalGroupProps) {
