...
import { selectCustomScrollbarsEnabled } from '@common/core/CommonSettings/store/commonSettingsSlice';
...
/**
 * CommonScrollbars Component for app-level scrollbar
 * Unlike normal scrollbars, this component supports mobile device as well
 */
const CommonScrollbars = forwardRef<HTMLDivElement, CommonScrollbarsProps>((props, ref) => {
	const {
		className = '',
		children,
		id = '',
	...
	const hookUpEvents = useCallback(() => {
		Object.keys(handlerNameByEvent).forEach((key) => {
			const callback = props[handlerNameByEvent[key] as keyof CommonScrollbarsProps] as (T: HTMLDivElement) => void;
...
export default CommonScrollbars;
