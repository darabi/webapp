...
/**
 * The CommonShortcuts component is responsible for rendering a list of shortcuts based on the navigation and shortcuts props.
 * It uses various MUI components to render the list items and search input.
 * The component is memoized to prevent unnecessary re-renders.
 */
function CommonShortcuts(props: CommonShortcutsProps) {
	...
	const [searchResults, setSearchResults] = useState<CommonFlatNavItemType[]>([]);
	const [shortcutItems, setShortcutItems] = useState<CommonFlatNavItemType[]>([]);

	useEffect(() => {
		const _shortcutItems = shortcuts
			? shortcuts.map((id) => _.find(navigation, { id }))
			: ([] as CommonFlatNavItemType[]);
...
function ShortcutMenuItem(props: {
	shortcuts: CommonShortcutsProps['shortcuts'];
	item: CommonFlatNavItemType;
