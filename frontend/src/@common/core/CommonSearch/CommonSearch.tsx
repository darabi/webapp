...
import { CommonFlatNavItemType } from '../CommonNavigation/types/CommonNavItemType';
...
function renderSuggestion(suggestion: CommonFlatNavItemType, { query, isHighlighted }: RenderSuggestionParams) {
...
function getSuggestions(value: string, data: CommonFlatNavItemType[]): CommonFlatNavItemType[] {
...
function getSuggestionValue(suggestion: CommonFlatNavItemType) {
...
type StateType = {
	searchText: string;
	search: boolean;
	navigation: CommonFlatNavItemType[];
	suggestions: CommonFlatNavItemType[];
...
type ActionType =
	...
	| { type: 'setNavigation'; data: CommonFlatNavItemType[] }
...
/**
 * Props for CommonSearch component
 */
...
/**
 * CommonSearch component
 */
function CommonSearch(props: CommonSearchProps) {
	const {
		navigation = [],
		className,
		variant = 'full',
	...
	function handleSuggestionSelected(
		...
		{ suggestion }: { suggestion: CommonFlatNavItemType }
	) {
