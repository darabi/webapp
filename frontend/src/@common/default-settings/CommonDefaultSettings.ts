import { commonDark } from '@common/colors';
...
/**
 * The defaultSettings object defines the default settings for the Common application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Common application.
 * It returns a CommonSettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings() {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as CommonSettingsConfigType;
	}
