...
import { setDefaultSettings } from "@common/core/CommonSettings/store/commonSettingsSlice"
...
export const changeLanguage = languageId => async (dispatch, getState) => {
  ...
  const { direction } = AppState.commonSettings.defaults
  ...
  if (newLangDirection !== direction) {
    await dispatch(setDefaultSettings({ direction }))
  }
